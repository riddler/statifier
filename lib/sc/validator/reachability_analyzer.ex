defmodule SC.Validator.ReachabilityAnalyzer do
  @moduledoc """
  ...
  """
  @spec validate_reachability(SC.Validator.validation_result(), SC.Document.t()) ::
          SC.Validator.validation_result()
  def validate_reachability(%SC.Validator{} = result, %SC.Document{} = document) do
  ...
  defp validate_all_reachable(%SC.Validator{} = result, all_states, reachable) do
    unreachable =
