defmodule Statifier.Validator.TransitionValidator do
  ...
  def validate_transition_targets(
    ...
    Enum.reduce(all_transitions, result, fn transition, acc ->
      validate_transition_targets_list(transition.targets, acc, document)
    end)
  end

  defp validate_transition_targets_list([], acc, _document) do
    # No targets to validate
    acc
  end

  defp validate_transition_targets_list(targets, acc, document) do
